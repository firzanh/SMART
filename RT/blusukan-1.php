			...
			<div class="collapse" id="collapseMenu">
				<div class="card-body sidenav-c mt-4 col-12 col-sm-12 col-md-12 col-lg-3" id="collapseMenu" style="background-color: #232D3F">	
					<center>
						...
						<a href="blusukan-1.php" class="btn btn-dashboard btn-primary" role="button"  id="btn-sekarang">
							Laporan Blusukan
						</a>
										...
										<div class="card" style="background-color: #5a357e;">
											<div class="card-body p-0">
												...
												<div class="card" style="border-radius: 0px; border-width: 0px">
													<div class="card-body status-warna" style="background-color: #01ff85;border-radius: 0px;">
													</div>
												</div>
												<div id="kunjungan">5 Kunjungan</div>
											</div>
										</div>
									</div>
									<div class="col-4 col-sm-4 col-md-3 card-status-kunjungan">
										<div class="card" style="background-color: #9d262a;">
											<div class="card-body p-0">
												<div id="nama">Firza</div>
												<div class="card" style="border-radius: 0px; border-width: 0px">
													<div class="card-body status-warna" style="background-color: #ca0088; border-radius: 0px; height: 5px">
													</div>
												</div>
												<div id="kunjungan">0 Kunjungan</div>
											</div>
										</div>
									</div>
									<div class="col-4 col-sm-4 col-md-3 card-status-kunjungan">
									...
									<div class="col-4 col-sm-4 col-md-3 card-status-kunjungan">
										<div class="card" style="background-color: #5a357e;">
											<div class="card-body p-0">
												<div id="nama">Firza</div>
												<div class="card" style="border-radius: 0px; border-width: 0px">
													<div class="card-body status-warna" style="background-color: #01ff85; border-radius: 0px; height: 5px">
													</div>
												</div>
												<div id="kunjungan">3 Kunjungan</div>
											</div>
										</div>
									</div>
									<div class="col-4 col-sm-4 col-md-3 card-status-kunjungan">
