...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../style/RT/pengumuman-1.css">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
	<script src="../js/jquery.min.js"></script>
	<script src="../js/RT/pengumuman-1.js"></script>
	<meta charset="utf-8">
		...
		<div class="row">
			...
			<div class="collapse" id="collapseMenu">
				<div class="card-body sidenav-c mt-4 col-12 col-sm-12 col-md-12 col-lg-3" id="collapseMenu" style="background-color: #232D3F">	
					<center>
						<a href="pengumuman-1.php" class="btn btn-dashboard" role="button" id="btn-sekarang">
							Pengumuman
						</a>
			...
			<div class="card-body sidenav mt-4 col-12 col-sm-12 col-md-4 col-lg-3" style="background-color: #232D3F">	
				<center>
					<a href="pengumuman-1.php" class="btn btn-dashboard btn-primary" role="button" id="btn-sekarang">
						Pengumuman
					</a>
					<a href="iuran-1.php" class="btn btn-dashboard btn-primary" role="button">
						Info Iuran
				...
				<div class="card-body" style="font-size: 18px; color: #00acec;">
					<center>
						<div class="col-12 col-sm-12 col-md-12 col-lg-12">
							<h5 id="j-buat-pengumuman" style="color: #19B4ED">Buat Pengumuman</h5><br>
							<form>
								<div class="form-group">
									<textarea class="form-control" id="exampleFormControlTextarea1" rows="2" placeholder="Tulis Judul Pengumuman"></textarea>
								</div>
								<div class="form-group">
									<textarea class="form-control" id="exampleFormControlTextarea1" rows="10" placeholder="Tulis Isi Pengumuman"></textarea>
								</div>
